...
import com.clickchat.clickchat.databinding.ActivityChatBinding
...
import com.clickchat.clickchat.ui.adapters.ChatAdapter
import com.clickchat.clickchat.utils.isSameDayAs
...
class ChatActivity : AppCompatActivity() {
    ...
    private fun sendMessage(message: String) {
        ...
        val msgMap = com.clickchat.clickchat.data.Message(message, mCurrentUid, xid!!)
    ...
    fun updateLastMessage(message: com.clickchat.clickchat.data.Message) {
    ...
    private fun listenToMessages() {
        getMessage(id!!).orderByKey().addChildEventListener(object : ChildEventListener {
            override fun onChildAdded(snapshot: DataSnapshot, previousChildName: String?) {
                val msg =
                    snapshot.getValue(com.clickchat.clickchat.data.Message::class.java)!!
    ...
    private fun addMessage(msg: com.clickchat.clickchat.data.Message) {
